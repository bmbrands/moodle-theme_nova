...
$nova = new \theme_arupboost\arupboost();
$nova->removenav();
$nova->backtocourse();
...
if ($PAGE->bodyid == 'page-mod-scorm-player') {
    echo $OUTPUT->render_from_template('theme_nova/scorm', $templatecontext);
} else {
    echo $OUTPUT->render_from_template('theme_nova/columns', $templatecontext);
}
