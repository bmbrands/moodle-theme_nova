...
[
    ...
    'theme_nova/imagehandler_cropworker'
],
function(
    $,
    Repository,
                ...
                reader.onload = (function(theFile) {
                    return function(e) {
                        ...
                        if (theFile.size > maxbytes) {
                            ...
                            var message = M.util.get_string('error:coverimageexceedsmaxbytes', 'theme_nova', maxbytesstr);
                        ...
                        $(img).on('load', function() {
                            if (img.width < 400) {
                                addCoverImageAlert(target, 'imagehandler-alert-cover-image-size',
                                    M.util.get_string('error:coverimageresolutionlow', 'theme_nova')
                                );
                            } else {
